...
import { GoogleMoA } from "../utils/google-ai";
import { ClaudeMoA } from "../utils/claude-ai";
...
const question = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    try {
      ...
      const moaModel = new ClaudeMoA();
      const answer = await moaModel.generateResponse(question);
